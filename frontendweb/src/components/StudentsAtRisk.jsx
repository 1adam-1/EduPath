...
import { AlertTriangle, Filter, Mail, ClipboardList, X, PlayCircle, FileText, Activity } from 'lucide-react';
            ...
            >
              ...
              <div className="flex gap-3 mt-4 pt-4 border-t border-[#F1F5F9]">
                ...
                <button
                  ...
                  className="px-4 py-2 bg-white border border-[#E2E8F0] text-[#334155] rounded-lg hover:bg-[#F8FAFC] transition">
